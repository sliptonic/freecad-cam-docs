...
* Click on the xref:operations/profile.adoc#profile-face-operation[CAM Profile Faces] icon to start the operation
...
* Click on the xref:operations/pocket.adoc[CAM Pocket Shape] icon to start the operation.
* Click the OK to create the operation - no faces selected
* Select the new Pocket++_++Shape operation in task window
