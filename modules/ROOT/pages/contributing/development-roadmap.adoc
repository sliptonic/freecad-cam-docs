...
This page will discuss the strategic objectives for the xref:index.adoc[CAM Workbench]. This shouldn't be a list of features to implement but broader objectives that will steer the overall direction of CAM development.
