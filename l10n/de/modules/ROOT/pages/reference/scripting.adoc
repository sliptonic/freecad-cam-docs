= CAM scripting
:page-origin: https://wiki.freecad.org/CAM_scripting/de
:page-imported: true
...
* Eine Bearbeitung ProfileFromFaces mit dem Namen "Profile++_++Faces" und einer leeren Basisgeometrie erstellen.
