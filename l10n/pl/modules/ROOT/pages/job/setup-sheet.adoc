= CAM SetupSheet
:page-origin: https://wiki.freecad.org/CAM_SetupSheet/pl
:page-imported: true
...
Karty konfiguracji są szczególnie przydatne po zapisaniu z xref:job/export-template.adoc[Szablonem zadania].
